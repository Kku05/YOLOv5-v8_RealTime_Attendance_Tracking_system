...
# Load YOLOv8 model
model = YOLO(os.path.join(BASE_DIR, 'yolov8/yolov8n.pt'))  # Use 'yolov8n' or your custom-trained YOLOv8 model
...
def see_attendance():
    ...
    if request.method == 'POST':
        ...
        if os.path.exists(attendance_folder):
            ...
            return render_template('see_attendance.html', error="No attendance records found for the selected date.", csv_files=[])
