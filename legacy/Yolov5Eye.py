...
# Load YOLOv5 model
model = YOLO(os.path.join(BASE_DIR, 'yolov5/yolov5su.pt'))  # Use 'yolov5su' or your custom-trained YOLOv5 model
...
def generate_frames():
    ...
    cap = cv2.VideoCapture(0)  # Use 0 for Mac default camera
...
def see_attendance():
    ...
    # Reset context variables for GET requests
    return render_template('see_attendance.html', csv_files=[], attendance_records=[])
